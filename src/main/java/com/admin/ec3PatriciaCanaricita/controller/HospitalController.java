package com.admin.ec3PatriciaCanaricita.controller;


import com.admin.ec3PatriciaCanaricita.model.Hospital;

import com.admin.ec3PatriciaCanaricita.service.HospitalService;
...
public class HospitalController {
    ...
    public ResponseEntity<?> borrar(@PathVariable Integer id_hospital) {
        ...
        if(h != null) {
            ...
            response.put("mensaje", "Hospital '" .concat(h.getNombre()).concat("' eliminado con exito!"));
    ...
    public ResponseEntity<?> editar(@RequestBody Hospital hospital) {
        ...
        if(h != null) {
            ...
            response.put("mensaje", "Hospital " + hospital.getNombre() + " actualizado con exito");
            return new ResponseEntity<Map<String, Object>>(response, HttpStatus.CREATED);
        }
        return new ResponseEntity<Map<String, Object>>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    }
